...
export const AppContextProvider = ({ children }) => {
    ...
    const logoutSeller = async () => {
        try {
            ...
            console.error("Failed to logout seller:", error);
    ...
    const fetchProducts = useCallback(async () => {
        try {
            const { data } = await axiosInstance.get(`/products/list?page=${pagination.page}&limit=${pagination.limit}`);
    ...
    }, [pagination.page, pagination.limit, isSeller]);
